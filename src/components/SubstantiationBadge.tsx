...
// Labels are passed in localized (DEC-026).
...
export function SubstantiationBadge({ substantiationComplete, needsReceipt, missingFields, labels }: Props) {
  let label: string;
  let cls: string;
