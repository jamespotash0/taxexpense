  ...
  return (
    <main className="mx-auto max-w-2xl px-6 py-12 text-gray-700">
      ...
      <section className="mt-6 space-y-4 text-sm leading-6">
        ...
        <p><b>SMS / TCPA.</b> By texting Tally you consent to receive SMS messages from us. Message &amp; data rates may apply. Reply STOP to opt out; reply HELP for help. We log your consent.</p>
