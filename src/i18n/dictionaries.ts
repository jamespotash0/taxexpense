...
const en = {
  ...
  onboarding: {
    ...
    phoneTitle: 'Want to skip the setup questions?',
    phoneSub: 'Drop your number and Tally recognizes your first text — you go straight to logging instead of answering setup questions.',
    phonePlaceholder: 'Your mobile number',
    phoneSaving: 'Saving…',
    phoneSkip: "Skip — I'll just text",
    phoneDisclaimer: "We won't text you until you text first. No spam.",
    exitLabel: '✕ Exit',
...
const es: Dict = {
  ...
  onboarding: {
    ...
    phoneTitle: '¿Quieres saltarte las preguntas de configuración?',
    phoneSub: 'Deja tu número y Tally reconocerá tu primer mensaje — vas directo a registrar en vez de responder preguntas de configuración.',
    phonePlaceholder: 'Tu número de celular',
    phoneSaving: 'Guardando…',
    phoneSkip: 'Saltar — mejor escribo',
    phoneDisclaimer: 'No te escribiremos hasta que tú escribas primero. Sin spam.',
    exitLabel: '✕ Salir',
