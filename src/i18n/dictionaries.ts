...
const en = {
  ...
  pricing: {
    ...
    subscribe: 'Subscribe',
    starting: 'Starting…',
    included: ['Unlimited capture by text', 'Follows the real IRS rules — shows the code behind each', 'Receipt reminders & tax-deadline alerts', 'Dashboard, CSV & QuickBooks export', 'Email your accountant in one tap'],
